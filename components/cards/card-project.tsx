        ...
        <div className="w-full">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center text-xs font-light text-muted-foreground">
              <Link href={link} className="inline-flex items-center hover:text-primary" target="_blank" rel="noreferrer">
                {linkText}
          ...
          {isExpanded && (
            <CardContent className="mt-2 w-full">
              <div className="mt-4 text-xl font-semibold">
                <h2 className="mb-4">Client: {client}</h2>
              </div>
              <div className="mt-4 text-xl font-semibold">
              ...
              <div className="mt-4 text-xs">
                <Gallery2 imgFolderPath={imgFolderPath} />
              </div>
            </CardContent>
          )}
        </div>
