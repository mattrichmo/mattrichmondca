    ...
    <section className="mx-12 flex h-screen flex-col items-center gap-6 pb-4 pt-6 sm:ml-4 md:py-10">
      <div className="xs:mt-6">
        <div className="flex max-w-[980px] flex-col items-start gap-4">
          ...
          <h2 className="mt-2 ml-12 text-md leading-tight tracking-tighter md:text-2xl" style={{ lineHeight: "1.5", fontFamily: "ETBembo, Palatino, 'Palatino Linotype', 'Palatino LT STD', 'Book Antiqua', Georgia, serif", fontWeight: "normal" }}>
            I am a Grip in the film industry, and I love photography, design, and code.
          </h2>
          <p className="mt-6 ml-12 text-lg max-w-[800px]" style={{ fontFamily: "ETBembo, Palatino, 'Palatino Linotype', 'Palatino LT STD', 'Book Antiqua', Georgia, serif", fontWeight: "normal" }}>
          ...
          <h2 className="mt-6 ml-12 text-md leading-tight tracking-tighter md:text-2xl" style={{ lineHeight: "1.5", fontFamily: "ETBembo, Palatino, 'Palatino Linotype', 'Palatino LT STD', 'Book Antiqua', Georgia, serif", fontWeight: "normal" }}>
      ...
      <div className="max-w mx-12 flex justify-center mt-auto mb-12">
        <Link href="/projects">
